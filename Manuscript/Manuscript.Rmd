---
title: Impacts of grazing and global change drivers on biodiversity and ecosystem function in alpine and arctic grasslands
author:
  - Aud H. Halbritter:
...
Global change and alpine ecosystems


How warming, nitrogen and grazing affect vegetation. Multiple global change drivers act at the same time.


Grazing as a tool to mitigate negative impacts. But we need more knowledge when this is the case.
...
knitr::include_graphics("figures/ExperimentalDesign.jpg")
...
```{r soil-plot, fig.cap = "Soil properties at three sites."}
...
```{r cover-plot, fig.cap = "Functional group cover."}
...
```{r richness-plot, fig.cap = "Richness"}
