...
tar_load(daily_climate_figure, store = here::here(tar_config_get("store")))
...
tar_load(productivity_consumption_figure, store = here::here(tar_config_get("store")))
...
tar_load(microclimate_stats, store = here::here(tar_config_get("store")))
microclimate_stats
...
tar_load(climate_figure, store = here::here(tar_config_get("store")))
climate_figure
```
...
tar_load(climate_stats, store = here::here(tar_config_get("store")))
climate_stats
...
tar_load(biomass_origin_anova_table, store = here::here(tar_config_get("store")))
tar_load(diversity_origin_anova_table, store = here::here(tar_config_get("store")))
