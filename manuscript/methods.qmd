...
<!-- Should we describe whole experiment and then say exclude 150 because too acid? Or leave out 150 block/treatment? -->
...
Microclimate data was recorded continuously every 15 minutes, between July 2019 and September 2022, using Tomst TM4 loggers [@Wild2019-nk]. Air, ground and soil temperature as well as soil moisture were measured at 15, 0 cm above and -6 cm below the ground in all warming and grazing treatments inside the fence and at 0, 1, 10, 100 and 150 kg N ha^-1^ y^-1^ (n = 72 loggers). At the alpine site, the block with 0.5 kg N ha^-1^ y^-1^ also received climate loggers, because this block is located further away from the rest and we wanted to make sure to catch any difference in the microclimate. The warming treatment increased air, ground and soil temperature by c. 3 °C and decreased soil moisture (Figure S1 and S8, Table S8), but nitrogen addition and grazing had no effect on the microclimate (Figure S8, Table S8).
